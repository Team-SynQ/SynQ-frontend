        ...
        <div className="flex-1 overflow-y-auto pt-6 pr-2 text-xs md:text-sm text-gray-600 space-y-6 leading-relaxed">
          ...
          <section className="space-y-3">
            ...
            <div className="overflow-hidden rounded-xl border border-gray-100">
              <table className="w-full text-xs text-left border-collapse">
                ...
                <tbody className="divide-y divide-gray-100 text-gray-600">
                  <tr>
                    <td className="py-2.5 px-2 border-r border-gray-100 font-medium text-center bg-gray-50/50">간편 회원가입</td>
                    <td className="py-2.5 px-2 border-r border-gray-100">이메일, 프로필 이름, 프로필 사진</td>
                    <td className="py-2.5 px-2 text-center font-bold text-gray-800">O</td>
                  </tr>
                  <tr>
                    <td className="py-2.5 px-2 border-r border-gray-100 font-medium text-center bg-gray-50/50">서비스 이용</td>
                    <td className="py-2.5 px-2 border-r border-gray-100">역할·관점 설정 정보, 프로젝트명, 회의 제목, 프로젝트 참여 정보</td>
                    <td className="py-2.5 px-2 text-center font-bold text-gray-800">O</td>
                  </tr>
                  <tr>
                    <td className="py-2.5 px-2 border-r border-gray-100 font-medium text-center bg-gray-50/50">회의 및 AI 기능 이용</td>
                    <td className="py-2.5 px-2 border-r border-gray-100">회의 음성 녹음, 실시간 전사 텍스트, 프로젝트 업로드 자료, AI Chat 질문 및 답변</td>
                    <td className="py-2.5 px-2 text-center font-bold text-gray-800">O</td>
                  </tr>
                  <tr>
                    <td className="py-2.5 px-2 border-r border-gray-100 font-medium text-center bg-gray-50/50">자동 수집 정보</td>
                    <td className="py-2.5 px-2 border-r border-gray-100">IP 주소, 접속 기기 정보, 접속 로그, 쿠키</td>
            ...
            <p className="text-xs text-gray-500 leading-relaxed pt-1">
              ※ 회의 음성에는 진행자 본인 외에 다른 회의 참가자의 음성 및 발화 내용이 포함될 수 있습니다. 이 경우 개인정보 수집의 근거는 회의를 진행하는 회원이 참가자로부터 받은 동의에 있으며, 회사는 회의 시작 전 녹음 및 AI 처리 여부를 참가자에게 고지할 수 있는 기능을 제공합니다.
            </p>
          </section>
          ...
          <section className="space-y-1">
            ...
            <ol className="list-decimal list-inside space-y-1">
              ...
              <li>다만, 프로젝트 자료 및 회의 기록 중 다른 프로젝트 멤버와 공유된 정보(전사, 전체 정리)는 프로젝트가 삭제되거나 해당 회의 기록이 삭제될 때까지 보관될 수 있으며, 탈퇴한 회원의 개인별 정리·AI Chat 기록은 즉시 삭제됩니다.</li>
          ...
          <section className="space-y-3">
            ...
            <div className="overflow-hidden rounded-xl border border-gray-100">
              <table className="w-full text-xs text-left border-collapse">
                ...
                <tbody className="divide-y divide-gray-100 text-gray-600">
                  <tr>
                    <td className="py-2.5 px-2 border-r border-gray-100 font-medium text-center bg-gray-50/50">AWS (Amazon Web Services)</td>
                    <td className="py-2.5 px-2">서버 호스팅, 데이터 저장</td>
                  </tr>
                  <tr>
                    <td className="py-2.5 px-2 border-r border-gray-100 font-medium text-center bg-gray-50/50">OpenAI, Gemini</td>
                    <td className="py-2.5 px-2">회의 음성의 텍스트 전사, AI 정리·힌트·Chat 응답 생성</td>
                  </tr>
                  <tr>
                    <td className="py-2.5 px-2 border-r border-gray-100 font-medium text-center bg-gray-50/50">카카오, 네이버, 구글</td>
                    <td className="py-2.5 px-2">회의 음성 녹음·소셜 로그인 인증, 실시간 전사 텍스트, 프로젝트 업로드 자료, AI Chat 질문 및 답변</td>
                  </tr>
                </tbody>
              </table>
            </div>
            ...
            <p className="text-xs text-gray-500 leading-relaxed pt-1">
              ※ 회사는 회의 음성, 전사, 프로젝트 자료를 AI 처리 목적 외의 별도 AI 모델 학습 데이터로 사용하지 않으며, 위탁업체에도 이를 요구하지 않습니다.
            </p>
          </section>
          ...
          <section className="space-y-1">
            ...
            <ol className="list-decimal list-inside space-y-1">
              ...
              <li>권리 행사는 서비스 내 설정 화면 또는 아래 문의처를 통해 요청할 수 있으며, 회사는 지체 없이 조치합니다.</li>
            </ol>
          </section>
          ...
          <section className="space-y-1">
            ...
            <ol className="list-decimal list-inside space-y-1">
              ...
              <li>개인별 정리, AI Chat 기록 등 개인 전용 데이터에 대한 접근 통제 (본인만 조회 가능)</li>
            </ol>
          </section>
