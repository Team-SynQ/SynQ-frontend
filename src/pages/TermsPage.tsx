      ...
      <div className="w-full max-w-[480px] h-[640px] bg-white rounded-2xl border border-gray-100 shadow-[0_8px_30px_rgb(0,0,0,0.04)] px-8 py-7 flex flex-col text-left">
        ...
        <div className="flex-1 overflow-y-auto pt-6 pr-2 text-xs md:text-sm text-gray-600 space-y-6 leading-relaxed">
          ...
          <section className="space-y-1">
            ...
            <p>
              이 약관은 SynQ(이하 "회사")가 제공하는 프로젝트 맥락 기반 AI 회의 이해 보조
              서비스 "SynQ"(이하 "서비스")의 이용과 관련하여 회사와 회원 간의 권리, 의무 및
          ...
          <section className="space-y-1">
            ...
            <ol className="list-decimal list-inside space-y-1">
              <li>서비스: 회사가 제공하는 SynQ 웹 서비스 및 이에 부수하는 모든 기능을 의미합니다.</li>
              <li>회원: 이 약관에 동의하고 소셜 로그인을 통해 회사와 이용계약을 체결한 자를 의미합니다.</li>
              <li>프로젝트: 회원이 팀원과 함께 자료, 회의 기록, 맥락 정보를 축적하는 단위 공간을 의미합니다.</li>
              <li>회의: 프로젝트 내에서 진행되며 음성 녹음 및 실시간 전사가 이루어지는 세션을 의미합니다.</li>
              <li>AI 정리: 회의 음성·전사와 프로젝트 맥락을 바탕으로 SynQ가 생성하는 힌트(의미·내 영향·팀 질문), 전체 정리, 개인별 정리를 의미합니다.</li>
              <li>프로젝트 자료: 회원이 프로젝트에 업로드한 문서, 참고자료 등 일체의 콘텐츠를 의미합니다.</li>
          ...
          <section className="space-y-1">
            ...
            <ol className="list-decimal list-inside space-y-1">
              ...
              <li>회사는 관련 법령을 위반하지 않는 범위에서 약관을 개정할 수 있으며, 개정 시 적용일자 및 개정사유를 명시하여 사전 공지합니다.</li>
          ...
          <section className="space-y-1">
            ...
            <ol className="list-decimal list-inside space-y-1">
              <li>회원가입은 카카오, 네이버, 구글 등 회사가 제공하는 소셜 로그인을 통해 이루어집니다.</li>
              <li>회원은 본인의 계정 정보를 스스로 관리해야 하며, 계정 정보 유출 또는 제3자 사용에 대한 책임은 회원에게 있습니다.</li>
              <li>회원은 가입 시 기본 역할·관점을 설정할 수 있으며, 프로젝트별로 이를 재설정할 수 있습니다.</li>
            </ol>
          </section>
          ...
          <section className="space-y-1">
            ...
            <p className="text-gray-500 pt-1">
              회의 녹음 및 AI 활용에 대해 다른 참가자의 동의를 받는 것은 회의를 진행하는 회원의 책임입니다. 회사는 이를 위한 고지 기능을 제공하나, 실제 동의 확보의 책임은 회원에게 있습니다.
            </p>
          </section>
          ...
          <section className="space-y-1">
            ...
            <ol className="list-decimal list-inside space-y-1">
              <li>프로젝트에 업로드된 자료 및 회의 기록(녹음, 전사, 전체 정리)의 소유권은 해당 프로젝트의 소유자 및 작성자에게 있습니다.</li>
              <li>회사는 서비스 제공을 위해 필요한 범위 내에서만 이를 처리하며, 회원의 동의 없이 타 목적으로 이용하지 않습니다.</li>
              <li>프로젝트 내 회의 기록과 전체 정리는 프로젝트 멤버 전원에게 공유됩니다.</li>
              <li>개인별 정리, AI 힌트, AI Chat 기록은 이를 생성한 해당 회원에게만 제공되며, 다른 참여자나 프로젝트 관리자에게 공개되지 않습니다.</li>
            </ol>
          </section>
          ...
          <section className="space-y-1">
            ...
            <ol className="list-decimal list-inside space-y-1">
              <li>SynQ 힌트, AI Chat 답변, 전체·개인별 정리는 AI가 생성한 참고 정보이며, 그 정확성과 완전성을 보장하지 않습니다.</li>
              <li>AI가 추정한 의미, 영향, 질문은 사실 확인이나 팀의 최종 합의를 대체하지 않으며, 담당자·일정·범위에 대한 최종 판단은 회원과 팀이 직접 내려야 합니다.</li>
              <li>회사는 회원의 회의 음성, 전사, 프로젝트 자료를 서비스 제공 목적 외의 AI 모델 학습에 사용하지 않습니다.</li>
            </ol>
          </section>
          ...
          <section className="space-y-1">
            ...
            <ol className="list-decimal list-inside space-y-1">
              <li>회사는 서비스 개선을 위해 기능을 추가, 변경할 수 있으며 이 경우 사전에 공지합니다.</li>
              <li>회사는 시스템 점검, 서버 장애, 천재지변 등 불가피한 사유로 서비스 제공을 일시 중단할 수 있습니다.</li>
            </ol>
          </section>
          ...
          <section className="space-y-1">
            ...
            <ol className="list-decimal list-inside space-y-1">
              ...
              <li>탈퇴 시 회원의 개인정보는 개인정보처리방침에 따라 처리되며, 프로젝트 자료 및 회의 기록은 프로젝트 소유권 및 다른 멤버와의 공유 관계를 고려하여 처리됩니다.</li>
              <li>회원이 탈퇴하더라도 팀의 원활한 협업을 위해 공유 공간에 기록된 공통 회의 전사 및 전체 정리는 삭제되지 않으며, 개인별 정리 및 개인 AI Chat 기록만 즉시 파기됩니다.</li>
            </ol>
          </section>
          ...
          <section className="space-y-1">
            ...
            <ol className="list-decimal list-inside space-y-1">
              ...
              <li>회사는 AI가 생성한 정리, 힌트, 답변의 내용에 대해 발생한 손해에 대해 고의 또는 중대한 과실이 없는 한 책임을 지지 않습니다.</li>
              <li>회사는 회원 간 회의 녹음 동의와 관련하여 발생하는 분쟁에 대해 책임을 지지 않습니다.</li>
              <li>회사는 천재지변, 제3자(클라우드, API 제공사 등)의 서비스 장애로 인해 발생한 손해에 대해 책임을 지지 않습니다.</li>
            </ol>
          </section>
          ...
          <section className="space-y-1">
            ...
            <p>
              이 약관과 관련한 분쟁에 대해서는 대한민국 법령을 준거법으로 하며, 관련 법령에 따른 관할 법원에 제소합니다.
            </p>
          </section>
        </div>
      </div>
