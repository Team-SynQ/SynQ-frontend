...
| 랜딩 및 인증   | [곽철용](https://github.com/youngchan-git) | 랜딩 페이지, 로그인, 온보딩, 회의기록전체 전사, 회의기록 더 보기                                           |
| 메인페이지     | [칠판](https://github.com/taegeon2)        | 프로젝트 메인보드, 프로젝트 생성 과정, 생성 이후 메인보드, AI 참고 자료 |
| 회의 전사 과정 | [도비](https://github.com/rlaehgus4418)    | 실시간 회의 전사 과정 UI 전체, 발화 흐름, 회의 중 인터랙션 영역, 튜토리얼페이지                           |
